...
func (m *MockUpdateListener) OnStateChange(stateUp bool) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "OnStateChange", stateUp)
}

// OnStateChange indicates an expected call of OnStateChange.
func (mr *MockUpdateListenerMockRecorder) OnStateChange(stateUp interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnStateChange", reflect.TypeOf((*MockUpdateListener)(nil).OnStateChange), stateUp)
}
